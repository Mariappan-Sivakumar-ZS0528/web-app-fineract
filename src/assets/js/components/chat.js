...
function getBotResponse(text) {
  botResponse = `<img class="botAvatar" src="./assets/images/MifosX_logo.png"/><span class="botMsg">${text}</span><div class="clearfix"></div>`;
  return botResponse;
}
...
function setBotResponse(response) {
  ...
  setTimeout(() => {
    ...
    if (response.length < 1) {
      ...
      const BotResponse = `<img class="botAvatar" src="./assets/images/MifosX_logo.png"/><p class="botMsg">${fallbackMsg}</p><div class="clearfix"></div>`;
        ...
        if (Object.hasOwnProperty.call(response[i], "text")) {
          if (response[i].text != null) {
            ...
            if (
              ...
              html = html.replaceAll("<br>", "");
              // botResponse = `<img class="botAvatar" src="./assets/img/MifosX_logo.png"/><span class="botMsg">${html}</span><div class="clearfix"></div>`;
              botResponse = getBotResponse(html);
            } else {
              // if no markdown formatting found, render the text as it is.
              if (!botResponse) {
                botResponse = `<img class="botAvatar" src="./assets/images/MifosX_logo.png"/><p class="botMsg">${response[i].text}</p><div class="clearfix"></div>`;
              }
            }
